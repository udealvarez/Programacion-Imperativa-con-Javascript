...
//console.log(frase.slice(6,11));
    ...
    // opcion 2
//console.log(frase.slice(6)); // en este caso toma lo que esta desde la posicion 6 hacia atras

    // opcion 3
//console.log(frase.slice(-10)); // el num por parametros es la cantidad de letras que va a retroceder
...
//console.log(saludo.split(" ")); // el separador va de manera de parametro, en este caso un espacio

//let arrayNuevo = saludo.split(", "); // separo el strin con la coma --> "hola", "como estas?"
